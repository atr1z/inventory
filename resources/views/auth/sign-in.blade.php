...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form method="POST" action="{{ route('auth.sign-in.post') }}" class="space-y-6">
            @csrf
        ...
        <div class="mt-6">
            ...
            <div class="mt-6 text-center text-sm">
                ...
                <p class="font-medium text-indigo-600">admin@example.com / password</p>
                <p class="mt-2 text-gray-600">Para acceder como vendedor:</p>
                <p class="font-medium text-indigo-600">seller@example.com / password</p>
            </div>
        </div>
    </div>
    <script>
